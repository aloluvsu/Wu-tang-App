//  ContentView.swift
//  Wu-tang App
//  Created by PRECIADO, ALONDRA on 4/15/26.
...
struct ContentView: View {
    ...
    private let firstColum = ["Algorithmic",
                           "Byte",
                           "Cache",
                           "Debug",
                           "Echo",
    ...
    func getWutangName (name: String) -> String {
        ...
        var firstColumIndex = 0
        for i in 0 ..< firstColum.count {
            if firstColum[i].first == firstLetter{
                firstColumIndex = i == 0 ? 25 : i-1
            }
        }
        return "\(firstColum[firstColumIndex]) \(secondColum.randomElement()!)"
    }
}
#Preview {
    ContentView()
